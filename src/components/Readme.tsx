  ...
  return (
    <div className="rounded-md border border-gray-700 py-1 my-4">
      <div className="flex items-center justify-between text-gray-500 mb-4 border-b px-4  border-gray-700">
        ...
        <div>
          <a href="/">
            <div className="flex justify-center items-center p-2 group hover:bg-gray-700 rounded-md transition duration-150 ease-in-out ">
              <svg
                className="w-4 h-4 fill-current group-hover:text-gray-500 rounded-md"
                viewBox="0 0 16 16"
              >
                <path
                  fill-rule="evenodd"
